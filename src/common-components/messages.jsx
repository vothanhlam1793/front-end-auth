...
const messages = defineMessages({
  ...
  'logistration.sign.in': {
    ...
    description:
      'Text that appears on the tab to switch between login and register'
  },
  ...
  'enterprisetpa.title.heading': {
    ...
    defaultMessage:
      'Would you like to sign in using your {providerName} credentials?',
  ...
  'sso.sign.in.with': {
    ...
    description:
      'Screen reader text that appears before social auth provider name'
  },
  ...
  'tpa.alert.heading': {
    ...
    description:
      'Success alert heading after user has successfully signed in with social auth'
  },
  'login.third.party.auth.account.not.linked': {
    id: 'login.third.party.auth.account.not.linked',
    defaultMessage:
      'You have successfully signed into {currentProvider}, but your {currentProvider} ' +
  ...
  'register.third.party.auth.account.not.linked': {
    ...
    defaultMessage:
      "You've successfully signed into {currentProvider}! We just need a little more information " +
  ...
  'registration.using.tpa.form.heading': {
    ...
    description:
      'Heading that appears above form when user is trying to create account using social auth'
  },
  supportTitle: {
  ...
  'registration.other.options.heading': {
    ...
    description:
      'A message that appears above third party auth providers i.e saml, google, facebook etc'
  },
